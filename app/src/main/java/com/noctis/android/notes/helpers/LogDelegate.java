...
import static com.noctis.android.notes.utils.ConstantsBase.PREF_ENABLE_FILE_LOGGING;
...
import com.noctis.android.notes.exceptions.GenericException;
...
public class LogDelegate {
  ...
  private static boolean isFileLoggingEnabled () {
    if (fileLoggingEnabled == null) {
      fileLoggingEnabled = NotesApp.getSharedPreferences().getBoolean(PREF_ENABLE_FILE_LOGGING, false);
      if (fileLoggingEnabled) {
        FL.init(new FLConfig.Builder(NotesApp.getAppContext())
