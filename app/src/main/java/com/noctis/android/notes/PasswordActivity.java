    ...
    if (passwordText == null) {
      ...
      Observable
          ...
          .doOnSubscribe(() -> prefs.edit()
                                    .putString(ConstantsBase.PREF_PASSWORD, Security.md5(passwordText))
                                    .putString(ConstantsBase.PREF_PASSWORD_QUESTION, questionText)
                                    .putString(ConstantsBase.PREF_PASSWORD_ANSWER, Security.md5(answerText))
                                    .commit())
