...
package com.noctis.android.notes.services;
...
import com.noctis.android.notes.async.bus.NotificationRemovedEvent;
...
public class NotificationListener extends NotificationListenerService {
  ...
  public static boolean isRunning () {
    ContentResolver contentResolver = NotesApp.getAppContext().getContentResolver();
