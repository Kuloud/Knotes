...
package com.noctis.android.notes.helpers.date;
...
public class RecurrenceHelper {
  ...
  public static String getNoteReminderText (long reminder) {
    return NotesApp.getAppContext().getString(R.string.alarm_set_on) + " " + DateHelper.getDateTimeShort(NotesApp
        .getAppContext(), reminder);
  }

  public static String getNoteRecurrentReminderText (long reminder, String rrule) {
    return formatRecurrence(NotesApp.getAppContext(), rrule) + " " + NotesApp.getAppContext().getString
        (R.string.starting_from) + " " + DateHelper.getDateTimeShort(NotesApp.getAppContext(), reminder);
  }
