...
import com.noctis.android.notes.async.CategoryMenuTask;
import com.noctis.android.notes.async.MainMenuTask;
import com.noctis.android.notes.async.bus.CategoriesUpdatedEvent;
import com.noctis.android.notes.async.bus.DynamicNavigationReadyEvent;
import com.noctis.android.notes.async.bus.NavigationUpdatedEvent;
...
import com.noctis.android.notes.models.NavigationItem;
...
public class NavigationDrawerFragment extends Fragment {
  ...
  public void onEvent (SwitchFragmentEvent event) {
    if (SwitchFragmentEvent.Direction.CHILDREN.equals(event.direction)) {
      animateBurger(ARROW);
    } else {
...
//		Resources resources = NotesApp.getAppContext().getResources();
