...
import com.noctis.android.notes.widget.ListWidgetProvider;
...
public class BaseActivity extends AppCompatActivity {
  ...
  protected void onResume () {
    ...
    navigation = prefs.getString(ConstantsBase.PREF_NAVIGATION, navNotes);
  ...
  public boolean updateNavigation (String nav) {
    ...
    prefs.edit().putString(ConstantsBase.PREF_NAVIGATION, nav).apply();
    navigation = nav;
    navigationTmp = null;
    return true;
  }
  ...
  public static void notifyAppWidgets (Context context) {
    ...
    // Dashclock
    LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(ConstantsBase.INTENT_UPDATE_DASHCLOCK));
  }
