...
public class CategoryActivity extends AppCompatActivity implements ColorChooserDialog.ColorCallback {
  ...
  protected void onCreate (Bundle savedInstanceState) {
    ...
    category = getIntent().getParcelableExtra(ConstantsBase.INTENT_CATEGORY);
  ...
  public void saveCategory () {
    ...
    getIntent().putExtra(ConstantsBase.INTENT_CATEGORY, category);
  ...
  public void deleteCategory () {
    ...
    new MaterialDialog.Builder(this)
        ...
        .onPositive((dialog, which) -> {
          ...
          String navigation = prefs.getString(ConstantsBase.PREF_NAVIGATION, navNotes);
          if (String.valueOf(category.getId()).equals(navigation)) {
            prefs.edit().putString(ConstantsBase.PREF_NAVIGATION, navNotes).apply();
          }
          ...
          BaseActivity.notifyAppWidgets(NotesApp.getAppContext());
