...
package com.noctis.android.notes.helpers;

import com.noctis.android.notes.NotesApp;
import com.noctis.android.notes.helpers.count.CountFactory;
...
import static com.noctis.android.notes.utils.ConstantsBase.MERGED_NOTES_SEPARATOR;
import static com.noctis.android.notes.utils.ConstantsBase.MIME_TYPE_AUDIO;
import static com.noctis.android.notes.utils.ConstantsBase.MIME_TYPE_FILES;
import static com.noctis.android.notes.utils.ConstantsBase.MIME_TYPE_IMAGE;
import static com.noctis.android.notes.utils.ConstantsBase.MIME_TYPE_SKETCH;
import static com.noctis.android.notes.utils.ConstantsBase.MIME_TYPE_VIDEO;

import com.noctis.android.notes.models.Attachment;
import com.noctis.android.notes.models.Note;
import com.noctis.android.notes.models.StatsSingleNote;
  ...
  public static void addAttachments (boolean keepMergedNotes, Note note, ArrayList<Attachment> attachments) {
    if (keepMergedNotes) {
      for (Attachment attachment : note.getAttachmentsList()) {
        attachments.add(StorageHelper.createAttachmentFromUri(NotesApp.getAppContext(), attachment.getUri
            ()));
      }
    } else {
