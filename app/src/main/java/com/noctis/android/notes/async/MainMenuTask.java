...
import com.noctis.android.notes.models.adapters.NavDrawerAdapter;
import com.noctis.android.notes.models.misc.DynamicNavigationLookupTable;
import com.noctis.android.notes.models.views.NonScrollableListView;
...
public class MainMenuTask extends AsyncTask<Void, Void, List<NavigationItem>> {
  ...
  private boolean checkSkippableItem (int i) {
    ...
    boolean dynamicMenu = prefs.getBoolean(ConstantsBase.PREF_DYNAMIC_MENU, true);
