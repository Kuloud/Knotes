...
import static com.noctis.android.notes.utils.ConstantsBase.ACTION_SHORTCUT;
import static com.noctis.android.notes.utils.ConstantsBase.INTENT_KEY;
import static com.noctis.android.notes.utils.ConstantsBase.PREF_PRETTIFIED_DATES;
...
public class ShortcutHelper {
  ...
  public static void addShortcut (Context context, Note note) {
    ...
    String shortcutTitle = note.getTitle().length() > 0 ? note.getTitle() : DateHelper.getFormattedDate(note
        .getCreation(), NotesApp.getSharedPreferences().getBoolean(PREF_PRETTIFIED_DATES, true));
