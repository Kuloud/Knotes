...
import static com.noctis.android.notes.utils.ConstantsBase.PREF_PASSWORD;
import static com.noctis.android.notes.utils.ConstantsBase.PREF_PASSWORD_ANSWER;
import static com.noctis.android.notes.utils.ConstantsBase.PREF_PASSWORD_QUESTION;
...
public class PasswordHelper {
  ...
  public static void resetPassword (final Activity mActivity) {
    ...
    MaterialDialog dialog = new MaterialDialog.Builder(mActivity)
        .title(NotesApp.getSharedPreferences().getString(PREF_PASSWORD_QUESTION, ""))
        ...
        .onPositive((dialogElement, which) -> {
          ...
          String oldAnswer = NotesApp.getSharedPreferences().getString(PREF_PASSWORD_ANSWER, "");
  ...
  public static void removePassword () {
    Observable
        ...
        .doOnCompleted(() -> {
          NotesApp.getSharedPreferences().edit()
