...
public class FabCameraNoteTest extends BaseEspressoTest {
  ...
  public void onEvent (NotesUpdatedEvent notesUpdatedEvent) {
    Assert.assertEquals(0, notesUpdatedEvent.notes.get(0).getAttachmentsList().size());
    Assert.assertEquals(Constants.MIME_TYPE_IMAGE, notesUpdatedEvent.notes.get(0).getAttachmentsList().get(0).getMime_type());
  }
